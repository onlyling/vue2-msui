...
部分滚动效果依赖[better-scroll](https://github.com/ustbhuangyi/better-scroll)

原本是打算自己写的，但是发现很多细节优化不到，至少放弃，用第三方工具。但是，对它还不熟，还要慢慢才坑。
...
2017.02.15对项目进行了部分升级，也就是`vue-cli`更新了，使用了新版本的`webpack`，啊哈哈哈。另外还对已完成的组件进行了修改。
